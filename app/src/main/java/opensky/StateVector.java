...
public class StateVector implements Serializable {
    ...
    private static int numAirplanes = 40;

    private static int stringSizes = 6 + 6 + 20 + 6;
	public static int dataSize =  numAirplanes * (9 * Double.SIZE / 8 + stringSizes + 2 + 2);// = 108 * 40 / 5000 = .86
